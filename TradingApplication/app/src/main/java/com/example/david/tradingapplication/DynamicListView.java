...
public class DynamicListView extends ListView {
    ...
    public ArrayList<CurrencyObject> mCurrencyList;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mCurrencyList, originalItem, getPositionForView(switchView));
    ...
    public void setCurrencyList(ArrayList<CurrencyObject> currencyList) {
